 ...
 */
function buildPublicationsByYear(
  outputs: ResearcherScientificOutput[],
): YearBucket[] {
...
export default function MetricsPanel({ scientificOutputs, onYearSelected }: MetricsPanelProps) {
    ...
    >
      ...
      <div>
        <div className="flex items-center gap-1.5">
          ...
          <div className="relative group">
            ...
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-56 p-2.5 rounded-md bg-[var(--color-text-neutral-primary)] text-[var(--color-bg-neutral-primary)] text-xs leading-relaxed opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-150 z-10">
              El h-index es un indicador que combina productividad e impacto científico. Un
              investigador tiene índice h igual a{' '}
        ...
        <div className="mt-2 flex gap-3">
          <div className="flex-1 rounded-md bg-[var(--color-bg-neutral-secondary)] px-3 py-2 text-center">
      ...
      <div className="mt-5">
        <p className="text-sm text-[var(--color-text-neutral-secondary)] mb-2">
