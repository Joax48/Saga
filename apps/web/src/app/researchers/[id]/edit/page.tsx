...
const LINK_FIELDS = [
  ...
  },
  {
    ...
    errorMessage:
      'Debe ser un enlace de LinkedIn (https://linkedin.com/in/usuario).',
  },
  {
  ...
  },
  {
    ...
    errorMessage:
      'Debe ser un enlace de Scopus (https://scopus.com/authid/detail.uri?authorId=...).',
  },
] as const;
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-6">
        ...
        <section className="bg-white rounded-xl px-6 sm:px-8 py-6 sm:py-7">
          <div className="pb-4 mb-5 border-b border-gray-200">
            ...
            <p className="mt-1 text-sm text-[var(--color-text-neutral-secondary)]">
              Agrega los enlaces a tus perfiles académicos para que otros investigadores puedan encontrarte.
            </p>
          </div>
        ...
        <div className="flex justify-end gap-3 pb-8">
          ...
          <Button
            ...
            onClick={() => {
              // Surface any pending validation errors before saving.
              if (hasLinkErrors) {
                setTouched({
                  orcidId: true,
                  linkedin: true,
              ...
              // TODO: connect to save handler once backend endpoint is ready
            }}
          >
            Guardar cambios
          </Button>
